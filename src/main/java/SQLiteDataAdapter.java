...
public class SQLiteDataAdapter implements IDataAdapter {
    ...
    public int saveProduct(ProductModel product) {
        try {
            String sql = "INSERT INTO Product(ProductID, Barcode, Name, Expiration, Date, Price, TaxRate, Quantity, Supplier, ManufacturedDate) VALUES " + product;
    ...
    public PurchaseModel loadPurchase(int purchaseID) {
        ...
        try {
            String sql = "SELECT PurchaseID, CustomerID, ProductID, Datetime, Quantity, Price, Tax, TotalCost FROM Purchase WHERE PurchaseID = " + purchaseID;
            Statement stmt = conn.createStatement();
            ResultSet rs = stmt.executeQuery(sql);
